...
- [LightRAG](https://lightrag.github.io/) ![Status](https://img.shields.io/badge/status-active-brightgreen) ![Language](https://img.shields.io/badge/language-Python-blue) - Graph RAG framework with dual-retrieval (low-level / high-level) system. The LightRAG Server is designed to provide Web UI and API support. 
